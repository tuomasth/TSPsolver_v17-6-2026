...
public class TSP_Solver_UEF {
    ...
    static int maxSomIterations = 40;
    static double somLearningRate = 0.15; // keeps decreasing 
    ...
    public static String SOM_NN_Algorithm(String input) {
        ...
        if(inputresult.equals("ok") && max >=4 && EUC_2D && 
            ...
            maxNeighbourhoodRadius = maxPossibleDistanceInHull/1.2;
            initAdditionalClusterCount(5);
            ...
            System.out.println("Entering the OPT phase");
